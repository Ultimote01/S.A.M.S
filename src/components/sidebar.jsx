...
export function SidebarHeader({ className, ...props }) {
  return (
    <div
      ...
      className={clsx(
        className,
        'flex flex-col border-b border-zinc-950/5 p-4 pb-2 dark:border-white/5 [&>[data-slot=section]+[data-slot=section]]:mt-2.5'
      )}
    />
  )
}
...
export function SidebarBody({ className, ...props }) {
  return (
    <div
      ...
      className={clsx(
        className,
        'flex flex-1 flex-col overflow-y-auto p-4 [&>[data-slot=section]+[data-slot=section]]:mt-16'
      )}
    />
  )
}
...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  let classes = clsx(
    // Base
    'flex w-full items-center gap-3 rounded-lg px-2 py-4.5 text-left text-base/6 font-medium text-zinc-950 sm:py-2 sm:text-sm/5',
