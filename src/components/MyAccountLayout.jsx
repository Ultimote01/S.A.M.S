                    ...
                    <div className="w-[100%] flex flex-col justify-center items-center">
                        ...
                        <div>
                           <div className="flex flex-col text-center">
                                <label htmlFor="my-fullName" className="font-semibold text-[1.9rem]">{`${createStringTitle(user.fullName.split(' ')[0])} ${createStringTitle(user.fullName.split(' ')[1])}`}</label>
                                <div className="flex items-center mt-4 justify-center"> 
                                <input disabled={true} className="text-center w-[40%]" id="my-fullname" name="my-fullname" value={`@${user.fullName.replace(" ","")}`}/>
                 ...
                 <form className="mt-16 px-4 md:px-0" >
                    <div className="flex flex-col justify-center items-center">
                        <div className="flex gap-x-2   flex-col">
                            ...
                            <div className="flex items-center bg-white   dark:bg-zinc-100 dark:border-gray-600 dark:text-zinc-600"> 
                            
                                <input  className="mr-2 w-[100%] dark:bg-zinc-100" id="username" type="text" name="username" 
                            ...
                            <div className="flex w-[100%] gap-x-[32.5%] items-center mt-[1.5rem] ">
                                ...
                                <div className="flex items-center   bg-white text-[1rem]  dark:bg-zinc-100 dark:border-gray-600 dark:text-zinc-600">
                                
                                <input disabled={true} className="mr-2 w-[100%] dark:bg-zinc-100" id="email"type="text" name="email" 
                                        value={`${user.email}`}
                                />
                                  <PencilIcon className="size-6"/>
                                </div>
                            ...
                            <div className="flex w-[100%] gap-x-[28%] items-center mt-[1.5rem] ">
                                ...
                                <input disabled={true} className="mr-2 w-[100%] dark:bg-zinc-100" id="gender"type="text" name="gender" 
                                        value={`${user.gender}`}
                                />
                                  <PencilIcon className="size-6"/>
                                </div>
                             ...
                             <div className="flex w-[100%] gap-x-[32%] items-center mt-[1.5rem] ">
                                ...
                                <input disabled={true} className="mr-2 w-[100%] dark:bg-zinc-100" id="dob"type="text" name="dob" 
                                        value={`${user.dob}`}
                                />
                                  <PencilIcon className="size-6"/>
                                </div>
